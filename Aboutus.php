...
<?php include('Navbar.php'); ?>
    ...
    <div class="about-container">
        ...
        <h2>Our Mission</h2>
        <p>Our mission is to simplify the management process for retailers, making it easier for them to focus on growing their business while we handle the backend of their stock management.</p>
        ...
        <p>We are committed to offering the best service possible and ensuring that your inventory runs smoothly and effectively at all times.</p>
    </div>
</body>
</html>
